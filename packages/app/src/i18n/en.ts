export const dict = {
  ...
  "prompt.dropzone.label": "Drop images, PDFs, audio, video, or text files here",
  ...
  "prompt.toast.pasteUnsupported.description": "Only images, PDFs, audio, video, or text files can be attached here.",
