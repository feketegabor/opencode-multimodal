...
import { fileHandlers, fileUploadRoute } from "./handlers/file"
...
const rawInstanceRoutes = Layer.mergeAll(ptyConnectRoute, fileUploadRoute).pipe(Layer.provide(instanceRouterLayer))
